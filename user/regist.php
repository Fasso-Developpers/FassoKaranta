				...
				else
				{
					...
					if(mysqli_query($con, $insertQuery))
					{
						...
						setcookie('userName', $userName, 0, '/', '', false, true);
							...
							echo $_COOKIE['email'];	
						/*send_email($email, 'Activate your account',
							"Hello M. ".$firstName." ".$lastName.",\n\n 
							Your email is used to register on karanta.fasso.org courses, 
							we don't know if it is you or onother one.
						...
						$succes  = trad_lang('succes_registred')." Plaese check your email to activate your account";
		...
		<form action='regist.php' method="post" 
			...
			<table>
				...
				<td <?php echo align_by_nko() ?>>
						<?php if (!isset($_GET['lang'])){ echo trad_nko('firstname');} ?> </td>
				</tr>
				...
				?> </td><td>
					...
					oninvalid="InvalidMsg(this);" oninput="InvalidMsg(this);" required /></td>
				<td <?php echo align_by_nko() ?>>
						<?php if (!isset($_GET['lang'])){ echo trad_nko('lastname');} ?> </td>
				</tr>
				...
				<tr><td <?php echo align_by_lang() ?> >
					...
					oninvalid="InvalidMsg(this);" oninput="InvalidMsg(this);" required /></td>
				<td <?php echo align_by_nko() ?>>
						<?php if (!isset($_GET['lang'])){ echo trad_nko('adressemail');} ?> </td>
				</tr>
				...
				<tr><td <?php echo align_by_lang() ?> >
					...
					oninvalid="InvalidMsg(this);" oninput="InvalidMsg(this);" required /></td>
				<td <?php echo align_by_nko() ?>>
						<?php if (!isset($_GET['lang'])){ echo trad_nko('confirmPassword');} ?> </td>
				</tr>
				...
				<tr><td></td><td><?php echo trad_lang('conditions'); ?> 
					...
					<td <?php echo align_by_nko() ?>>
						<?php if (!isset($_GET['lang'])){ echo trad_nko('conditions');} ?> </td>
				</tr>
			</table>
